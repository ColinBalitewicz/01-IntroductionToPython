...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         Aaron Wilkin, their colleagues, Colin Balitewicz.
"""
###############################################################################
#
# Done: 1.
...
#
###############################################################################
rolling_stone = rg.SimpleTurtle()
rolling_stone.speed=10000
rolling_stone.pen = rg.Pen('black',1000)
rolling_stone.go_to(rg.Point(0,800))
###############################################################################
#
# TODO: 6.
